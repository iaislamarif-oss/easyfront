      ...
      <main className="w-full max-w-[800px] z-10 mt-12">
        <div className="glass-card rounded-xl p-8 md:p-10 flex flex-col">
          <div className="mb-6 flex flex-col items-center">
            ...
            <h1 className="text-[24px] font-bold text-on-surface-variant text-center">Refund Policy</h1>
          </div>
          ...
          <div className="prose prose-slate max-w-none text-slate-600 text-[15px] leading-relaxed">
            ...
            <h3 className="text-brand-900 font-bold mt-6 mb-2">1. Eligibility for Refunds</h3>
            ...
            <h3 className="text-brand-900 font-bold mt-6 mb-2">3. Exceptions</h3>
